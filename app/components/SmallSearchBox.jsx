...
export default function SmallSearchBox() {
  ...
  return (<div className="relative lg:hidden">
    ...
    {isOpen && (
      <form onSubmit={(e) => handleSubmit(e)} className="absolute translate-y-3 -translate-x-6 z-20 lg:hidden flex items-center space-x-3 overflow-hidden border bg-white border-gray-400 rounded-full h-[47px] w-[300px] pl-6">
